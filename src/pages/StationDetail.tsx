...
export default function StationDetail() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        <h2 className="text-lg font-display font-bold text-foreground mb-4">BiLSTM + CNN Forecast</h2>
        {loading ? (
          <div className="bg-card rounded-xl border border-border h-[400px] flex items-center justify-center">
            <div className="text-center">
              <div className="animate-spin h-8 w-8 border-4 border-primary border-t-transparent rounded-full mx-auto mb-3" />
              <p className="text-muted-foreground text-sm">Running BiLSTM + CNN prediction model...</p>
            </div>
          </div>
        ) : (
